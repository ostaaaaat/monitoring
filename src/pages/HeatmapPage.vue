...
export default {
  ...
  data() {
    return {
      ...
      regions: [
        { label: 'Ворошиловский', value: {lat_min: 30.00000,  lat_max: 39.99999,  lon_min: -120.00000,  lon_max: -129.99999} },
        { label: 'Дзержинский', value: {lat_min: 40.00000,  lat_max: 49.99999,  lon_min: -120.00000,  lon_max: -129.99999} },
        { label: 'Краснооктябрьский', value: {lat_min: 50.00000,  lat_max: 59.99999,  lon_min: -120.00000,  lon_max: -129.99999} },
      ],
      heatmapData: [
